...
function EditProfilePopup(props) {
  return (
    ...
    >
      ...
      <label className="popup__input-wrapper">
        <input type="text" className="popup__input popup__input_change_job" name="about" placeholder="Вид деятельности" maxLength="200" minLength="2" required id="job-input"/>
